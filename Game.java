...
////			 Graphics2D g2 = (Graphics2D) g;
		 Image img1 = Toolkit.getDefaultToolkit().getImage("nyn.png");
	 ...
	 public void drawSnake(Graphics g)
	 {
		 ...
		 {int y;
			 ...
			 {	
				 ...
				 Image img1 = Toolkit.getDefaultToolkit().getImage("poptarthue.png");
				 g.drawImage(img1, (pt.getX() * 22) + 39, y-10, this);
				 counter++;
			 }
			 if (irri)
			 {
...
//		    box.add(game);
//		    //box.add(a);
//		    game.controlpanel.setPreferredSize(new Dimension(50,400));
//		  
//		  
//		    box.add(game.controlpanel);
